...
#include "common/factory/shapes.hpp"
#include "common/factory/sdfs.hpp"
#include "common/factory/marching_cubes.hpp"

#ifndef IKINCLUDE
#define IKINCLUDE
#include "common/IK/skeleton.hpp"
#endif

#include "common/animations/skinning.hpp"
...
int main() {
    ...
    */
    ...
    skin_mesh(cube_1, skeleton);
    skin_mesh(plane_, skeleton);
    cube_0.skeleton = skeleton;
