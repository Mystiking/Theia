...
int main() {
    ...
    Mesh I = create_sphere_mesh(glm::vec3(0.0f, 0.0f, 0.0f), 2.5f, 4);
    // L(1)
    ...
    // Loading in shaders
    GLuint programID = LoadShaders( "../shaders/VertexShaderRTiaW.glsl",
	...
	do{
        ...
        glUniform3f(cameraPositionID, CameraLocation[0], CameraLocation[1], CameraLocation[2]);
